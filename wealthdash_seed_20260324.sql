...
-- ============================================================
-- COMMON STOCKS (NSE) — seed for quick start
-- ============================================================
...
-- BSE equivalents for common stocks
INSERT INTO `stock_master` (`exchange`, `symbol`, `company_name`, `isin`, `sector`) VALUES
...
-- ============================================================
-- CSV TEMPLATE HEADERS (reference only — actual files in templates/)
-- portfolio,fund_name,scheme_code,folio,platform,txn_type,txn_date,units,nav,notes
-- ============================================================
