...
FROM nps_schemes;
-- peak_nav seeding
INSERT IGNORE INTO mf_peak_progress (scheme_code, status) SELECT scheme_code, 'pending' FROM funds WHERE is_active = 1;
INSERT INTO app_settings (setting_key, setting_val) VALUES ('peak_nav_batch_date', '2001-01-01') ON DUPLICATE KEY UPDATE setting_val = setting_val;
INSERT IGNORE INTO app_settings (setting_key, setting_val) VALUES ('session_idle_minutes', '30'), ('2fa_required', '0'), ('crypto_auto_refresh', '1'), ('peak_nav_batch_date', '2001-01-01');
