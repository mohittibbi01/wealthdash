...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2026 at 03:08 AM
...
--
-- Table structure for table `epf_accounts`
--
...
CREATE TABLE `epf_accounts` (
  ...
  `employee_contribution` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'monthly',
  `employer_contribution` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'monthly (12% of basic)',
  `eps_contribution` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'from employer share',
...
CREATE TABLE `funds` (
  ...
  `returns_1y` decimal(6,2) DEFAULT NULL COMMENT '1 Year return %',
  `returns_3y` decimal(6,2) DEFAULT NULL COMMENT '3 Year CAGR %',
  `returns_5y` decimal(6,2) DEFAULT NULL COMMENT '5 Year CAGR %',
  `returns_updated_at` date DEFAULT NULL COMMENT 'When returns were last calculated'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `goal_buckets`
--
...
--
-- Table structure for table `goal_fund_links`
--
...
CREATE TABLE `loan_accounts` (
  ...
  `emi_date` tinyint(2) NOT NULL DEFAULT 5 COMMENT 'day of month',
  `start_date` date NOT NULL,
...
ALTER TABLE `bank_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_bank_portfolio` (`portfolio_id`);

--
-- Indexes for table `bank_balance_history`
--
ALTER TABLE `bank_balance_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_bbh_account` (`account_id`);

--
-- Indexes for table `epf_accounts`
--
ALTER TABLE `epf_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_epf_portfolio` (`portfolio_id`);
...
ALTER TABLE `funds`
  ...
  ADD KEY `idx_returns_1y` (`returns_1y`),
  ADD KEY `idx_returns_3y` (`returns_3y`),
  ADD KEY `idx_returns_5y` (`returns_5y`),
  ADD KEY `idx_fund_manager` (`fund_manager`(50));
...
--
-- Indexes for table `goal_buckets`
--
...
--
-- Indexes for table `goal_fund_links`
--
ALTER TABLE `goal_fund_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_gfl_goal` (`goal_id`);
...
ALTER TABLE `import_logs`
  ...
  ADD KEY `idx_il_imported_at` (`imported_at`);
...
ALTER TABLE `insurance_policies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_ins_portfolio` (`portfolio_id`);
...
ALTER TABLE `loan_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_loan_portfolio` (`portfolio_id`);
...
ALTER TABLE `mf_transactions`
  ...
  ADD KEY `idx_import_fp` (`import_fingerprint`);
...
--
-- AUTO_INCREMENT for table `bank_balance_history`
--
ALTER TABLE `bank_balance_history`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `epf_accounts`
--
ALTER TABLE `epf_accounts`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `goal_buckets`
--
ALTER TABLE `goal_buckets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `goal_fund_links`
--
ALTER TABLE `goal_fund_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bank_accounts`
  ADD CONSTRAINT `fk_bank_portfolio` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `bank_balance_history`
--
ALTER TABLE `bank_balance_history`
  ADD CONSTRAINT `fk_bbh_account` FOREIGN KEY (`account_id`) REFERENCES `bank_accounts` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `epf_accounts`
--
ALTER TABLE `epf_accounts`
  ADD CONSTRAINT `fk_epf_portfolio` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `goal_fund_links`
--
ALTER TABLE `goal_fund_links`
  ADD CONSTRAINT `fk_gfl_goal` FOREIGN KEY (`goal_id`) REFERENCES `goal_buckets` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `insurance_policies`
  ADD CONSTRAINT `fk_ins_portfolio` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `loan_accounts`
--
ALTER TABLE `loan_accounts`
  ADD CONSTRAINT `fk_loan_portfolio` FOREIGN KEY (`portfolio_id`) REFERENCES `portfolios` (`id`) ON DELETE CASCADE;
...
UPDATE nav_download_progress p JOIN funds f ON f.scheme_code = p.scheme_code SET p.fund_id = f.id WHERE p.fund_id IS NULL OR p.fund_id = 0;
