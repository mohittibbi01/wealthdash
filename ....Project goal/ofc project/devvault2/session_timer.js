...
(function () {
  ...
  /* State colors — all use CSS vars so theme works */
  #dv-timer.dv-ok    { color: var(--muted,#5a7a9a); border-color: var(--border,#1e2d4a); background: var(--surface2,#111a2e); }
  #dv-timer.dv-warn  { color: var(--amber,#ffd740); border-color: rgba(255,215,64,.35); background: var(--surface2,#111a2e); }
  #dv-timer.dv-alert { color: var(--danger,#ff3d5a); border-color: rgba(255,61,90,.35); background: var(--surface2,#111a2e); }
