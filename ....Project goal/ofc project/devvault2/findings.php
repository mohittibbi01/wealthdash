...
.tnav{display:flex;gap:2px}.tnav a{color:var(--muted);text-decoration:none;font-size:12px;font-weight:600;padding:5px 10px;border-radius:6px;font-family:'Rajdhani',sans-serif;transition:all .15s}
.tnav a:hover{color:var(--text);background:var(--surface2)}.tnav a.cur{color:var(--accent)}
.btn{display:inline-flex;align-items:center;gap:5px;padding:6px 12px;border-radius:7px;font-size:12px;font-weight:600;font-family:'Rajdhani',sans-serif;cursor:pointer;border:none;text-decoration:none;transition:all .15s;white-space:nowrap}
...
.page-title{font-family:'Orbitron',monospace;font-size:16px;font-weight:700;color:var(--accent);text-shadow:0 0 12px var(--accent);margin-bottom:14px}
...
.schip .num{font-size:24px;font-weight:700;font-family:'Orbitron',monospace;color:var(--accent)}
...
.overdue{color:var(--danger);font-size:9px;font-weight:700;font-family:'Share Tech Mono',monospace}
...
<div class="topbar">
  ...
  <div class="tnav">
    ...
    <a href="findings.php" class="cur">🔍 Audit Findings</a>
  ...
  <div class="card">
    ...
    <form method="post" id="bulk-form">
      ...
      <div style="padding:8px 14px;background:var(--surface3);border-bottom:1px solid var(--border);display:flex;align-items:center;gap:12px">
        <label style="display:flex;align-items:center;gap:6px;font-size:11px;font-family:'Share Tech Mono',monospace;color:var(--muted);cursor:pointer">
