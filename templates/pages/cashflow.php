<?php
/**
 * WealthDash — t471/t159: Monthly Cashflow Page
 */
...
<div class="page-wrapper">
  <div class="page-header" style="padding:24px 0 20px;border-bottom:1px solid var(--border);margin-bottom:24px;">
    <h1 class="page-title" style="margin:0;font-size:24px;font-weight:700;">Monthly Cashflow</h1>
