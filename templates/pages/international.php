<?php
/**
 * WealthDash — t121: International Stocks Page
 */
...
$pageTitle     = 'International Stocks';
...
<div class="page-wrapper">
  <div class="page-header" style="padding:24px 0 20px;border-bottom:1px solid var(--border);margin-bottom:24px;">
    <h1 class="page-title" style="margin:0;font-size:24px;font-weight:700;">International Stocks</h1>
